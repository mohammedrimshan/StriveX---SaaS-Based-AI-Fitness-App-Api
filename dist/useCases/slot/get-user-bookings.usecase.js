...
let GetUserBookingsUseCase = class GetUserBookingsUseCase {
    ...
    execute(userClientId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bookedSlots = yield this.slotRepository.findBookedSlotsByClientId(userClientId);
            if (bookedSlots.length === 0) {
                throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.NO_BOOKINGS_FOUND, constants_1.HTTP_STATUS.NOT_FOUND);
            }
            return bookedSlots;
        });
    }
