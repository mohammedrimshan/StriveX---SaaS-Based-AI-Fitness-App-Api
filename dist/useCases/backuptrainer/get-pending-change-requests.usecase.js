...
exports.GetPendingChangeRequestsUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const constants_1 = require("@/shared/constants");
let GetPendingChangeRequestsUseCase = class GetPendingChangeRequestsUseCase {
    ...
    execute(skip, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const requests = yield this.changeRequestRepository.find({ status: constants_1.TrainerChangeRequestStatus.PENDING }, skip, limit);
...
exports.GetPendingChangeRequestsUseCase = GetPendingChangeRequestsUseCase;
exports.GetPendingChangeRequestsUseCase = GetPendingChangeRequestsUseCase = __decorate([
...
], GetPendingChangeRequestsUseCase);
