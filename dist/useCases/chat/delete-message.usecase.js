    ...
    execute(messageId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.senderId !== userId) {
                throw new custom_error_1.CustomError("Unauthorized to delete this message", constants_1.HTTP_STATUS.FORBIDDEN);
            }
            const deleted = yield this._messageRepository.delete(messageId);
            if (!deleted) {
                throw new custom_error_1.CustomError("Failed to delete message", constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR);
            }
        });
    }
};
