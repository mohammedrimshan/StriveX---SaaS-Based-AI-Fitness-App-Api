...
exports.GetChatHistoryUseCase = void 0;
...
let GetChatHistoryUseCase = class GetChatHistoryUseCase {
    ...
    execute(user1Id, user2Id, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this._messageRepository.getConversation(user1Id, user2Id, skip, limit);
            return result;
        });
    }
};
