...
exports.GetMatchedTrainersUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("@/entities/utils/custom.error");
const constants_1 = require("@/shared/constants");
let GetMatchedTrainersUseCase = class GetMatchedTrainersUseCase {
    ...
    execute(clientId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { items: trainers } = yield this._trainerRepository.find({
                _id: { $in: client.matchedTrainers },
                approvalStatus: constants_1.TrainerApprovalStatus.APPROVED
            }, 0, client.matchedTrainers.length);
            return trainers;
        });
    }
};
exports.GetMatchedTrainersUseCase = GetMatchedTrainersUseCase;
exports.GetMatchedTrainersUseCase = GetMatchedTrainersUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("IClientRepository")),
    __param(1, (0, tsyringe_1.inject)("ITrainerRepository")),
    __metadata("design:paramtypes", [Object, Object])
], GetMatchedTrainersUseCase);
