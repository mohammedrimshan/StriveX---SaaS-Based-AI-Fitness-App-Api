...
let ClientLoginStrategy = class ClientLoginStrategy {
    ...
    login(user) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield this._clientRepository.findByEmail(user.email);
            ...
            if (user.password) {
                const isPasswordMatch = yield this._passwordBcrypt.compare(user.password, client.password);
                if (!isPasswordMatch) {
