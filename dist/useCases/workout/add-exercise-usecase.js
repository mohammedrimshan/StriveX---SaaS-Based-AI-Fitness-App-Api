...
exports.AddExerciseUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("@/entities/utils/custom.error");
const constants_1 = require("@/shared/constants");
let AddExerciseUseCase = class AddExerciseUseCase {
    ...
    execute(workoutId, exerciseData, files) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (files === null || files === void 0 ? void 0 : files.video) {
                try {
                    ...
                    throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.VIDEOS_UPLOAD_FAILED, constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR);
                }
            }
            if (!videoUrl) {
                throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.VIDEO_URL_REQUIRED, constants_1.HTTP_STATUS.BAD_REQUEST);
            }
            const newExercise = {
            ...
            const updatedWorkout = yield this._workoutRepository.update(workoutId, {
...
exports.AddExerciseUseCase = AddExerciseUseCase;
exports.AddExerciseUseCase = AddExerciseUseCase = __decorate([
