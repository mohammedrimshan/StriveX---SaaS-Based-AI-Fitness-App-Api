...
let ReportPostUseCase = class ReportPostUseCase {
    ...
    execute(postId, userId, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedPost = yield this.postRepository.addReport(postId, report);
            if (!updatedPost)
...
exports.ReportPostUseCase = ReportPostUseCase = __decorate([
