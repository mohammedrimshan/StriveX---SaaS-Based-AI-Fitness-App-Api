...
let GetPostUseCase = class GetPostUseCase {
    ...
    execute(postId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const comments = yield this.commentRepository.findByPostId(postId, 0, 10);
            return { post, comments };
        });
    }
};
exports.GetPostUseCase = GetPostUseCase;
exports.GetPostUseCase = GetPostUseCase = __decorate([
