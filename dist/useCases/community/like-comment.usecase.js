...
let LikeCommentUseCase = class LikeCommentUseCase {
    ...
    execute(commentId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedComment = hasLiked
                ? yield this.commentRepository.removeLike(commentId, userId)
                : yield this.commentRepository.addLike(commentId, userId);
            if (!updatedComment)
...
exports.LikeCommentUseCase = LikeCommentUseCase = __decorate([
