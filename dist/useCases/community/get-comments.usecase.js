...
let GetCommentsUseCase = class GetCommentsUseCase {
    constructor(commentRepository) {
        this.commentRepository = commentRepository;
    }
    execute(postId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            if (page < 1 || limit < 1) {
                throw new custom_error_1.CustomError("Invalid pagination parameters", constants_1.HTTP_STATUS.BAD_REQUEST);
            }
            const skip = (page - 1) * limit;
            const result = yield this.commentRepository.findByPostId(postId, skip, limit);
            return result;
        });
    }
};
exports.GetCommentsUseCase = GetCommentsUseCase;
exports.GetCommentsUseCase = GetCommentsUseCase = __decorate([
