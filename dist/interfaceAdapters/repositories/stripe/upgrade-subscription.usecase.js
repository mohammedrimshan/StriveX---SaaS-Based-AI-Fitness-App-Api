...
let UpgradeSubscriptionUseCase = class UpgradeSubscriptionUseCase {
    constructor(clientRepository, membershipPlanRepository, paymentRepository, stripeService) {
    ...
    execute(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!currentPlan) {
                throw new custom_error_1.CustomError("Current plan not found", constants_1.HTTP_STATUS.NOT_FOUND);
            }
            ...
            const { url, sessionId } = yield this.stripeService.createCheckoutSession(clientId, { id: newPlan.id, price: amountToCharge, name: newPlan.name }, successUrl, cancelUrl);
            const payment = {
                clientId,
