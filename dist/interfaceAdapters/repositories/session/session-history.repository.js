...
let SessionHistoryRepository = class SessionHistoryRepository extends base_repository_1.BaseRepository {
    constructor() {
        super(session_history_model_1.SessionHistoryModel);
    }
    getPerformanceStats(trainerId) {
        return __awaiter(this, void 0, void 0, function* () {
            const [completed, total, uniqueClients] = yield Promise.all([
...
exports.SessionHistoryRepository = SessionHistoryRepository = __decorate([
